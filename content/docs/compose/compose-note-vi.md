---
weight: 999
title: "Lưu ý Jetpack Compose, Cách tối ưu và tránh lỗi"
description: ""
icon: "article"
...
* Cách dùng: kotlin Copy   items(userList, key = { it.id }) { user -> ... }
*   
...
* CompositionLocal:
    ...
    * Ví dụ:
* kotlin Copy   val LocalSpacing = compositionLocalOf { 8.dp }
